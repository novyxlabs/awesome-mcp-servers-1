...
- <img src="https://novyxlabs.com/favicon.ico" height="14"/> [Novyx MCP](https://github.com/novyxlabs/novyx-mcp) - Persistent memory for AI agents with 91 tools: remember, recall, rollback, audit, knowledge graph, governed actions, eval, cortex, and more. Local SQLite (zero-config) or Novyx Cloud.
